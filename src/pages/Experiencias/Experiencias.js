  ...
  const experiences = [
    {
      ...
      skillsPt: ['Gerenciamento de Projetos', 'Desenvolvimento Web', 'Colaboração em Equipe'],
      skillsEn: ['Project Management', 'Web Development', 'Team Collaboration'],
    },
    {
    ...
    },
    {
      ...
      skillsPt: ['Criação de Sites', 'Hospedagem de Sites', 'Desenvolvimento Web'],
      skillsEn: ['Website Creation', 'Website Hosting', 'Web Development']
    },
    {
